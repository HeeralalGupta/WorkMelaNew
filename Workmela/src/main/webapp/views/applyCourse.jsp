          ...
          <form action="search" method="GET">
            <div class="col-md-5 mx-auto">
              <div class="input-group backgroundSearch mx-auto">
                ...
                <input class="form-control border-end-0 border rounded-pill pl-2" type="search"
                  placeholder="Type to search..." id="title" name="title">
                <span class="input-group-append">
                  <button
                    class="btn btn-outline-secondary bg-gray border-bottom-0 border rounded-pill ms-n5"
                    type="button">
