	...
	<div class="main-container">
		...
		<div class="main">
			...
			<!-- Body start -->
						...
						<%
						if(session.getAttribute("postInternship") != null){
							out.print("<div class='alert'><span class='closebtn'>&times;</span> <strong>Success!</strong> You have posted an Internship.</div>");
						}
						%>
				...
				<div class="form_wrapper">
				  <div class="form_container">
				    ...
				    <div class="row clearfix">
				      <div class="">
				        <form action="postInternship" method="post" enctype="multipart/form-data">
							<div class="row clearfix">
					            <div class="col_half">
					              <div class="input_field"> <span><i aria-hidden="true" class="fa fa-header"></i></span>
					                <input type="text" name="internTitle" placeholder="Internship Title" required/>
					              </div>
					            </div>
					            <div class="col_half">
					              <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user-circle-o"></i></span>
					                <input type="text" name="internRole" placeholder="Role" required />
					              </div>
					            </div>
					            <div class="col_half">
					              <div class="input_field"> <span><i aria-hidden="true" class="fa fa-book"></i></span>
					                <input type="text" name="interDescription" placeholder="Description" required />
					              </div>
					            </div>
					            <div class="col_half">
							...
							<div class="row clearfix">
					            ...
					            <div class="col_half">
					              <div class="input_field"> <span><i aria-hidden="true" class="fa fa-list-alt"></i></span>
					                <input type="text" name="internCategory" placeholder="Category" required />
					              </div>
					            </div>
					            <div class="col_half">
					            ...
					            <div class="col_half">
					              <div class="input_field"> <span><i aria-hidden="true" class="fa fa-calculator"></i></span>
					                <input type="number" name="opening" placeholder="Number Opening" required />
					              </div>
					            </div>
				          </div>    
							<div class="row clearfix">
			    ...
			    <table>
			      <thead>
			        <tr>
			          ...
			          <th>INTERN TITILE</th>
			          <th>INTERN ROLE</th>
			          <th>INTERN LOCATION</th>
			          <th>INTERN STIPEND</th>
			          <th>OPENING</th>
			          <th>POST DATE</th>
			          <th>ACTION</th>
			        </tr>
			      ...
			      <tbody>
			      <c:forEach items="${allInternship}" var="intern" varStatus = "counter">
				        <tr>
				          <td> <input type="checkbox"/></td>
				          <td>${counter.count}</td>
				          <td>${intern.internTitle}</td>
				          <td>${intern.internRole}</td>
				          <td>${intern.location}</td>
				          <td>${intern.stipend}</td>
				          <td>${intern.opening}</td>
				          <td>${intern.postDate}</td>
